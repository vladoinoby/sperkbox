...
<!-- MODULE MailAlerts -->
    ...
    {/if}
	<a href="#"  class="btn btn-default" title="{l s='Notify me when available' mod='mailalerts'}" id="mailalert_link" rel="nofollow">{l s='Notify me when available' mod='mailalerts'}</a>
