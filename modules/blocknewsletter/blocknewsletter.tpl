...
<section id="newsletter_block_left" class="footer-block col-xs-12 col-sm-3">
		...
		<span class="promo-text">{l s='Sign up to receive latest news and updates direct to your inbox' mod='blocknewsletter'} <span style="font-size: 18px;">Neujde Vám žiadna akcia</span></span>
