...
{assign var='productAttributeId' value=$product.id_product_attribute}
	{ldelim}
		...
		"image": {$link->getImageLink($product.link_rewrite, $product.id_image, 'small_default')|json_encode},
		...
		"name": {$product.name|trim|html_entity_decode:2:'UTF-8'|truncate:55:'...':true|json_encode},
