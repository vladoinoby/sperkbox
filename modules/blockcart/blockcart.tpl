...
<div id="shopping_cart_container" class="col-xs-12 col-sm-{4-$warehouse_vars.logo_width/2} clearfix{if $PS_CATALOG_MODE} header_user_catalog{/if}">
{/if}
	<div class="shopping_cart">
		<a href="{$link->getPageLink($order_process, true)|escape:'html':'UTF-8'}" title="{l s='View my shopping cart' mod='blockcart'}" rel="nofollow">
			<span class="cart_name">{l s='Cart' mod='blockcart'}</span><div class="more_info">
				...
				<div class="block_content">
					...
					<div class="cart_block_list{if isset($blockcart_top) && !$blockcart_top}{if isset($colapseExpandStatus) && $colapseExpandStatus eq 'expanded' || !$ajax_allowed || !isset($colapseExpandStatus)} expanded{else} collapsed unvisible{/if}{/if}">
						...
						<p class="cart-buttons">
							<a id="button_order_cart" class="btn btn-default button button-medium" href="{$link->getPageLink("$order_process", true)|escape:"html":"UTF-8"}" title="{l s='Check out' mod='blockcart'}" rel="nofollow">
								<span>
	...
	<div id="layer_cart">
			...
			<div class="layer_cart_product col-xs-12 col-md-6">
				...
				<div class="layer_cart_product_info">
					...
					<div>
						<strong>{l s='Total' mod='blockcart'}
