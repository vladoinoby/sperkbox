<div id="opc_new_account" class="opc-main-block">
	...
	<h1 class="step-num my-h1"><span>1.</span> {l s='Vyplňte potrebné údaje'}</h1>
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html'}" method="post" id="new_account_form" class="std" autocomplete="on" autofill="on">
		<fieldset>
					<div class="">
								<h3 id="new_account_title"  class="my-subheading">{l s='Pre nových zákazníkov'}</h3>
									<div id="opc_account_choice" class="">
									<!--  <div class="col-xs-12 col-md-6"> -->
												<!--<p class="title_block">{l s='Instant Checkout'}</p> -->
												<!--<p class="opc-button">-->
														<a href="{$link->getPageLink('authentication', true)|escape:'html'}" id="opc_guestCheckout" class="btn btn-default button exclusive-medium2" style="color: white; margin-bottom: 5px;"><span><i class="fa fa-lock left"></i> {l s='Guest checkout'}</span></a>
													<!--  <button type="submit" class="btn btn-default button button-medium" id="opc_guestCheckout"><span>{l s='Guest checkout'}</span></button> -->
												<!--</p>-->
										<!-- </div> -->
									...
									<!--  <div class="col-xs-12 col-md-6"> -->
										<!--    <p class="title_block">{l s='Create your account today and enjoy:'}</p> -->
											...
											-->
												<!--<p class="opc-button">-->
														<!--<button type="submit" class="btn btn-default button exclusive-medium2" id="opc_createAccount"><span><i class="fa fa-user left"></i>{l s='Create an account'}</span></button>-->
														<a href="{$link->getPageLink('authentication', true)|escape:'html'}" id="opc_createAccount" class="btn btn-default button exclusive-medium2" style="color: white; margin-bottom: 5px;"><span><i class="fa fa-lock left"></i> {l s='Create an account'}</span></a>
												<!--</p>-->
									<!--  </div> -->
...
<!--
	...
	-->
				...
				<div class="submit opc-add-save clearfix">
						...
						<button type="submit" name="submitAccount" id="submitAccount" class="btn btn-default button exclusive-medium2" style="color: white; width: 350px"><span>{l s='Prosím potvrďte správnosť údajov'}<i class="fa fa-single-right right"></i></span></button><br />
	...
	<form action="{$link->getPageLink('authentication', true, NULL, "back=order-opc")|escape:'html':'UTF-8'}" method="post" id="login_form" class="">
		<fieldset>
			<h3 class="my-subheading">{l s='Already registered?'}</h3>
			<a href="{$link->getPageLink('authentication', true)|escape:'html'}" id="openLoginFormBlock" class="btn btn-default button exclusive-medium2" style="color: white;"><span><i class="fa fa-lock left"></i> &nbsp; Prihl&aacute;ste sa do V&aacute;&scaron;ho &uacute;čtu</span></a>
