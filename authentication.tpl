...
{if !isset($email_create)}
	...
	<div class="authentication row">
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="create-account_form" class="container-with-large-icon login-form">
		...
		<div class="col-xs-12 col-sm-6">
			<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="login_form" class="container-with-large-icon login-form">
				...
				<div class="form_content clearfix">
					...
					<p class="lost_password form-group"><a href="{$link->getPageLink('password')|escape:'html':'UTF-8'}" title="{l s='Recover your forgotten password'}" rel="nofollow">{l s='Lost password?'}</a></p>
					<p class="submit">
						{if isset($back)}<input type="hidden" class="hidden" name="back" value="{$back|escape:'html':'UTF-8'}" />{/if}
	...
	{if isset($inOrderProcess) && $inOrderProcess && $PS_GUEST_CHECKOUT_ENABLED}
		...
		<!--			<div class="form-group date-select">
					...
					<div id="opc_invoice_address"  class="unvisible">
						...
						{if $field_name eq "company" && $b2b_enable}
						<div class="form-group">
							<label for="company_invoice">{l s='Company'}aaa</label>
			...
			<p class="cart_navigation required submit clearfix">
				...
				<button type="submit" class="btn btn-default button exclusive-medium2" name="submitGuestAccount" id="submitGuestAccount">
					<span>
						{l s='Next'}
...
{else}
	...
	<form action="{$link->getPageLink('authentication', true)|escape:'html':'UTF-8'}" method="post" id="account-creation_form" class="form-horizontal std box">
		...
		<div class="account_creation panel panel-default">
			...
			<div class="required form-group">
				<label for="customer_firstname" class="control-label col-sm-4">{l s='First name'} <sup>*</sup></label>
				<div class="col-sm-6">
			...
			<div class="required form-group">
				<label for="customer_lastname" class="control-label col-sm-4">{l s='Last name'} <sup>*</sup></label>
				<div class="col-sm-6">
			...
			<div class="required form-group">
				<label for="email" class="control-label col-sm-4">{l s='Email'} <sup>*</sup></label>
				<div class="col-sm-6">
			...
			<div class="required password form-group">
				<label for="passwd" class="control-label col-sm-4">{l s='Password'} <sup>*</sup></label>
				<div class="col-sm-6">
	...
	<!--		<div class="form-group">
		...
		{if $b2b_enable}
			<div class="account_creation panel panel-default">
				<h3 class="panel-heading">{l s='Your company information'}</h3>
				<div class="panel-body">
					<div class="form-group">
						<label class="control-label col-sm-4">{l s='Company'}</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="company" name="company" value="{if isset($smarty.post.company)}{$smarty.post.company}{/if}" />
						</div>
					</div>
					<div class="form-group">
						<label for="siret" class="control-label col-sm-4">{l s='SIRET'}</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="siret" name="siret" value="{if isset($smarty.post.siret)}{$smarty.post.siret}{/if}" />
						</div>
					</div>
					<div class="form-group">
						<label for="ape" class="control-label col-sm-4">{l s='APE'}</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" id="ape" name="ape" value="{if isset($smarty.post.ape)}{$smarty.post.ape}{/if}" />
						</div>
					</div>
					<div class="form-group">
						<label for="website" class="control-label col-sm-4">{l s='Website'}</label>
						<div class="col-sm-6">
		...
		{if isset($PS_REGISTRATION_PROCESS_TYPE) && $PS_REGISTRATION_PROCESS_TYPE}
			<div class="account_creation panel panel-default">
				<h3 class="panel-heading">{l s='Your address'}</h3>
				<div class="panel-body">
					{foreach from=$dlv_all_fields item=field_name}
						{if $field_name eq "company"}
							{if !$b2b_enable}
								<div class="form-group">
									<label for="company" class="control-label col-sm-4">{l s='Company'}</label>
									<div class="col-sm-6">
										<input type="text" class="form-control" id="company" name="company" value="{if isset($smarty.post.company)}{$smarty.post.company}{/if}" />
									</div>
								</div>
						...
						{elseif $field_name eq "vat_number"}
							<div id="vat_number" style="display:none;">
								<div class="required form-group">
									<label for="dni" class="control-label col-sm-4">{l s='Identification number'} <sup>*</sup></label>
									<div class="col-sm-6">
										<input type="text" class="form-control" name="dni" id="dni" value="{if isset($smarty.post.dni)}{$smarty.post.dni}{/if}" />
									</div>
								</div>
								<div class="form-group">
									<label for="vat_number" class="control-label col-sm-4">{l s='VAT number'}</label>
									<div class="col-sm-6">
						...
						{elseif $field_name eq "firstname"}
							<div class="required form-group">
								<label for="firstname" class="control-label col-sm-4">{l s='First name'} <sup>*</sup></label>
								<div class="col-sm-6">
						...
						{elseif $field_name eq "lastname"}
							<div class="required form-group">
								<label for="lastname" class="control-label col-sm-4">{l s='Last name'} <sup>*</sup></label>
								<div class="col-sm-6">
						...
						{elseif $field_name eq "address1"}
							<div class="required form-group">
								<label for="address1" class="control-label col-sm-4">{l s='Address'} <sup>*</sup></label>
								<div class="col-sm-6">
									<input type="text" class="form-control" name="address1" id="address1" value="{if isset($smarty.post.address1)}{$smarty.post.address1}{/if}" />
						...
						{elseif $field_name eq "address2"}
							<div class="form-group is_customer_param">
								<label for="address2" class="control-label col-sm-4">{l s='Address (Line 2)'}</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" name="address2" id="address2" value="{if isset($smarty.post.address2)}{$smarty.post.address2}{/if}" />
						...
						{elseif $field_name eq "postcode"}
							{assign var='postCodeExist' value=true}
							<div class="required postcode form-group">
								<label for="postcode" class="control-label col-sm-4">{l s='Zip/Postal Code'} <sup>*</sup></label>
								<div class="col-sm-6">
									<input type="text" class="form-control" name="postcode" id="postcode" value="{if isset($smarty.post.postcode)}{$smarty.post.postcode}{/if}" onkeyup="$('#postcode').val($('#postcode').val().toUpperCase());" />
								</div>
							</div>
						{elseif $field_name eq "city"}
							<div class="required form-group">
								<label for="city"  class="control-label col-sm-4">{l s='City'} <sup>*</sup></label>
								<div class="col-sm-6">
									<input type="text" class="form-control" name="city" id="city" value="{if isset($smarty.post.city)}{$smarty.post.city}{/if}" />
								</div>
							</div>
						...
						{elseif $field_name eq "Country:name" || $field_name eq "country"}
							<div class="required form-group">
								<label for="id_country" class="control-label col-sm-4">{l s='Country'} <sup>*</sup></label>
								<div class="col-sm-4">
									<select name="id_country" id="id_country" class="form-control">
										<option value="">-</option>
										{foreach from=$countries item=v}
						...
						{elseif $field_name eq "State:name" || $field_name eq 'state'}
							{assign var='stateExist' value=true}
							<div class="required id_state select form-group">
								<label for="id_state" class="control-label col-sm-4">{l s='State'} <sup>*</sup></label>
								<div class="col-sm-6">
									<select name="id_state" id="id_state" class="form-control">
										<option value="">-</option>
									</select>
					...
					<div class="textarea form-group">
						<label for="other" class="control-label col-sm-4">{l s='Additional information'}</label>
						<div class="col-sm-6">
					...
					{/if}
					<div class="form-group">
						<label for="phone" class="control-label col-sm-4">{l s='Home phone'}</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="phone" id="phone" value="{if isset($smarty.post.phone)}{$smarty.post.phone}{/if}" />
						</div>
					</div>
					<div class="{if isset($one_phone_at_least) && $one_phone_at_least}required {/if}form-group">
						<label for="phone_mobile" class="control-label col-sm-4">{l s='Mobile phone'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>*</sup>{/if}</label>
						<div class="col-sm-6">
							<input type="text" class="form-control" name="phone_mobile" id="phone_mobile" value="{if isset($smarty.post.phone_mobile)}{$smarty.post.phone_mobile}{/if}" />
						</div>
					</div>
					<div class="required form-group" id="address_alias">
						<label for="alias" class="control-label col-sm-4">{l s='Assign an address alias for future reference.'} <sup>*</sup></label>
						<div class="col-sm-6">
			...
			<div class="account_creation dni panel panel-default">
				<h3 class="panel-heading">{l s='Tax identification'}</h3>
				<div class="panel-body">
					<div class="required form-group">
						<label for="dni" class="control-label col-sm-4">{l s='Identification number'} <sup>*</sup></label>
						<div class="col-sm-6">
