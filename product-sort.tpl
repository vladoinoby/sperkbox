...
<ul class="display">
    ...
    <li id="list" class="visible-md visible-lg"><a rel="nofollow" href="#" title="{l s='List'}"><i class="icon-th-list"></i></a></li>
    <li id="tableview" class="visible-md visible-lg"><a rel="nofollow" href="#" title="{l s='Table'}"><i class="icon-table"></i></a></li>
</ul>
