...
{else}
    ...
    <p>IČO: 44434537</p>
    <p>DIČ: 2022742139</p>
    <p>IČ DPH: SK2022742139</p>
    <p></p>
    <p>Zapísaný: Okresný súd Žilina/p>
    <p>Oddiel: Sro</p>
    <p>Vložka číslo: 50258/L</p>

    <p></p>
    <p><strong>Bankové spojenie</strong></p>
    <p>Peňažný ústav: Tatrabanka, a.s.</p>
    <p>IBAN: SK68 1100 0000 0026 2586 5716</p>
    <p>SWIFT (BIC): TATRSKBX</p>
    <p>Číslo účtu: 2625865716 / 1100</p>

    <p></p>

    <p><strong>Na Vaše objednávky dohliada:</strong></p>
    <p></p>
   	<img src="/img/cms/kontakt.png" alt="Kontakt" />
   	 <p>Peter Kuchár</p>
    <p>Tel.: +421 414 224 172</p>
    <p>E-mail: info@argento.sk</p>
